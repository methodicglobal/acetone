...
namespace MockService
{
    ...
    /// </summary>
    internal sealed class MockService : StatelessService
    {
        public MockService(StatelessServiceContext context)
            : base(context)
        { }
        ...
        private static X509Certificate2? GetCertificateFromStore()
        {
            try
            {
                ...
                if (string.Equals(env, "Development", StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    var cert = FindFirst(certs =>
                    {
                        var byOid = certs.Find(X509FindType.FindByExtension, aspNetHttpsOid, false);
